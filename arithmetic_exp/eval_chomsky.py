...
import wandb
from arithmetic_exp.data.formal_language.formal_language_dataset import FormLangDatasetGenerator
...
def get_data(directory_path):
    ...
    model = FPLMHeadModel(config).to(device)
    # Load model weights
...
if __name__ == "__main__":
    ...
    dirs = {
        'ours': "saved_models_FPMamba1_20250708_143848_seed_2"
    }

 
    model, test_loader, device, vocab_size, synth_lang_type, max_seq_length = get_data(args.directory)
