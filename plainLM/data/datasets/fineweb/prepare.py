...
N_train_tokens = 2_000_000_000
N_valid_tokens = 100_000
N_tokens_per_row = 660

nrows = int(np.ceil(N_train_tokens / N_tokens_per_row)) + int(np.ceil(N_valid_tokens / N_tokens_per_row))
...
valid_data_ratio = N_valid_tokens / (N_valid_tokens + N_train_tokens)

valid_set = lm_datasets.select(range(int(np.ceil(valid_data_ratio * len(lm_datasets)))))
train_set = lm_datasets.select(range(int(np.ceil(valid_data_ratio * len(lm_datasets))), len(lm_datasets)))
