...
out_path = "/fast/fsarnthein/data/lm/codeparrot/codeparrot_valid_16392ctx"

# HF dataset name
dataset_name = "codeparrot/codeparrot-clean"
split = 'train'

nrows = 1_000 # ~ 10M tokens
...
raw_dataset = load_dataset(
  ...
  streaming = True,
  #columns=["content"],  # it works only for Parquet datasets in streaming mode: https://github.com/huggingface/datasets/issues/4114#issuecomment-1090484293
  cache_dir = CACHE_DIR,
)
...
def tokenize_function(examples):
  ...
  tokenized_output = tokenizer(
      add_eos_batched(examples["content"]),
...
tokenized_datasets = dataset.map(
  tokenize_function, 
  remove_columns=['repo_name', 'path', 'copies', 'size', 'license', 'hash', 'line_mean', 'line_max', 'alpha_frac', 'autogenerated', 'content'],
  **map_setup
)
